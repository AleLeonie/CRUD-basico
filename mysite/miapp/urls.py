...
urlpatterns = [
    ...
    path('usuario/usuariostipos/editar/<str:id_usuario_tipo>/', views.usuario_tipo_update, name='usuario_tipo_update'),
    ...
    path('usuario/paises/editar/<str:id_pais>/', views.pais_update, name='pais_update'),
